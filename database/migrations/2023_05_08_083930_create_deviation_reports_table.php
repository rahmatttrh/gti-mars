...
class CreateDeviationReportsTable extends Migration
{
   /**
    * Run the migrations.
    *
   ...
   public function up()
   {
      Schema::create('deviation_reports', function (Blueprint $table) {
         $table->id();
         $table->mediumInteger('deviation_id');
   ...
   {
      Schema::dropIfExists('deviation_reports');
   }
}
