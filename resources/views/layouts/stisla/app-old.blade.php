    ...
    <div class="main-wrapper container">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <div class="nav-collapse">
          ...
          <ul class="navbar-nav">
            <li class="nav-item active"><a href="#" class=" btn btn-info shadow-none mr-2">DSP</a></li>
            <li class="nav-item"><a href="#" class="btn btn-info shadow-none mr-2">VDR</a></li>
            <li class="nav-item"><a href="#" class="btn btn-info shadow-none">AIMS</a></li>
          </ul>
        </div>
