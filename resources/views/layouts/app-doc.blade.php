                        ...
                        <a href="/" class="navbar-brand sidebar-gone-hide">
                            @if (auth()->user() != null)
                                @if (auth()->user()->hasRole('superuser') ||
                                        auth()->user()->hasRole('logistic') ||
                                        auth()->user()->hasRole('drilling') ||
                                        auth()->user()->hasRole('marine') ||
                                        auth()->user()->hasRole('vessel') ||
                                        auth()->user()->hasRole('port') ||
                                        auth()->user()->hasRole('department'))
                                    <img src="{{ asset('img/logo/phe-oses.png') }}" alt="DSP-PHE"
                                ...
                                @elseif(auth()->user()->hasRole('platform'))
                                    @if (auth()->user()->getLogo())
                                        <img src="{{ asset('storage/' . auth()->user()->getLogo()) }}" width="110"
                                            height="32" alt="DSP-PHE" class="navbar-brand-image">
                                    @else
                                        <img src="{{ asset('img/logo/logo.png') }}" width="110" height="32"
                                            alt="DSP-PHE" class="navbar-brand-image">
                                    @endif

                                    <div class="ml-2" style="margin-left: 10px; font-weight: 900">
                                        {{ auth()->user()->getSystem() }} <span class="text-primary">SYSTEM</span>
                                    </div>
                                @elseif(auth()->user()->hasRole('retail'))
                                    ...
                                    @if (auth()->user()->getPartyLogo())
                                        <img src="{{ asset('storage/' . auth()->user()->getPlatformLogo()) }}"
                                            width="110" height="32" alt="DSP-PHE" class="navbar-brand-image">
                                    @else
                                        <img src="{{ asset('img/logo/logo.png') }}" width="110" height="32"
                                            alt="DSP-PHE" class="navbar-brand-image">
                                    @endif
                                    <div class="ml-2" style="margin-left: 10px; font-weight: 900">
                                        {{ auth()->user()->getPlatformSystem() }} <span
                                            class="text-primary">SYSTEM</span></div>
                                @elseif(auth()->user()->hasRole('supplier'))
                                    @if (auth()->user()->getPartyLogo())
                                        <img src="{{ asset('storage/' . auth()->user()->getPartyLogo()) }}"
                                            width="110" height="32" alt="DSP-PHE" class="navbar-brand-image">
                                    @else
                                        <img src="{{ asset('img/logo/logo.png') }}" width="110" height="32"
                                            alt="DSP-PHE" class="navbar-brand-image">
                                ...
                                @elseif(auth()->user()->hasRole('receiving'))
                                    <img src="{{ asset('img/logo/logo.png') }}" width="110" height="32"
                                        alt="DSP-PHE" class="navbar-brand-image">
                                    <div class="ml-2" style="margin-left: 10px; font-weight: 900">DSP <span
                                            class="text-primary">SYSTEM</span></div>
                    ...
                    <div class="row text-center align-items-center flex-row-reverse">
                        <div class="col-lg-auto ms-lg-auto">
                            <ul class="list-inline list-inline-dots mb-0">
                                <li class="list-inline-item"><a href="./docs/index.html" class="link-secondary">MARS
                                        v1.0.0-beta</a></li>
        ...
        <div class="modal-dialog modal-sm" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer bg-whitesmoke">
                    ...
                    <a href="{{ route('vdr.approve.suptent', enkripRambo($vdr->id)) }}"
