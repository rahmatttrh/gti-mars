...
@section('content')
        <div class="container-fluid">
            ...
            <div class="main-breadcrumb d-flex align-items-center my-3 position-relative">
                {{-- <h2 class="breadcrumb-title mb-0 flex-grow-1 fs-14">{{$today->format('F')}}</h2> --}}
                <div class="dropdown breadcrumb-title mb-0 flex-grow-1 fs-14">
                  <a href="#" class=" dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                     {{$monthName}}
                  </a>
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{route('bod.dashboard.month', enkripRambo(1))}}">January</a></li>
                    <li><a class="dropdown-item" href="{{route('bod.dashboard.month', enkripRambo(2))}}">February</a></li>
                    <li><a class="dropdown-item" href="{{route('bod.dashboard.month', enkripRambo(3))}}">March</a></li>
                    <li><a class="dropdown-item" href="{{route('bod.dashboard.month', enkripRambo(4))}}">April</a></li>
                    <li><a class="dropdown-item" href="{{route('bod.dashboard.month', enkripRambo(5))}}">May</a></li>
                    <li><a class="dropdown-item" href="{{route('bod.dashboard.month', enkripRambo(6))}}">June</a></li>
                    <li><a class="dropdown-item" href="{{route('bod.dashboard.month', enkripRambo(7))}}">July</a></li>
                    <li><a class="dropdown-item" href="{{route('bod.dashboard.month', enkripRambo(8))}}">Augustus</a></li>
                    <li><a class="dropdown-item" href="{{route('bod.dashboard.month', enkripRambo(9))}}">September</a></li>
                    <li><a class="dropdown-item" href="{{route('bod.dashboard.month', enkripRambo(10))}}">October</a></li>
                    <li><a class="dropdown-item" href="{{route('bod.dashboard.month', enkripRambo(11))}}">November</a></li>
                    <li><a class="dropdown-item" href="{{route('bod.dashboard.month', enkripRambo(12))}}">December</a></li>
                  </ul>
                </div>
                     ...
                     <div class="col-xxl-9">
                         <div class="card">
                             <div class="card-header">
                                 <h4>Daily Fuel & Fresh Water Consumption</h4>
                             </div>
