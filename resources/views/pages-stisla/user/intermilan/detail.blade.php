            ...
            <div class="card">
                <div class="card-body">
                    <h4>INTERMILAN USER</h4>
                        ...
                        <small><b>Note:</b> Dokumen ini hanya dapat diakses oleh user pembuat. Setelah dilakukan submit, dokumen akan diteruskan ke pihak Marine untuk diproses dan disusun menjadi dokumen final Intermilan.</small>
            ...
            <div class="card ">
               ...
               <div class="card-body px-3">
                  <div class="d-flex justify-content-between" >
                     <div>
                        <h5>DETAIL INTERMILAN USER</h5>
                        <small>Intermilan User merupakan fitur yang digunakan oleh user untuk melakukan perencanaan permintaan kapal dalam periode mingguan</small>
                        <br>
                        <small><b>Note:</b> Dokumen ini hanya dapat diakses oleh user pembuat. Setelah dilakukan submit, dokumen akan diteruskan ke pihak Marine untuk diproses dan disusun menjadi dokumen final Intermilan.</small>
                    </div>
                  ...
                  <table class="table-striped border table-sm">
                     ...
                     <tr>
                        <td colspan="4" class="border">
                            <a data-toggle="collapse" href="#formRequest" class="btn btn-sm btn-primary" ><i class="fa fa-plus"></i> Add Row Activity</a>
                            <a class="btn btn-sm btn-success" href="{{asset('template/template-import-material.xlsx')}}"><i class="fa fa-download"></i> Download Template Import Material</a>
                        </td>
                     </tr>
                  </table>
