                     ...
                     {{-- <div class="d-flex align-items-center px-3"> --}}
                        ...
                        @if (auth()->user()->hasRole('fm'))
                           @if ($vdr->status == 11)
                              ...
                              <a href="#" class="btn  btn-info " data-toggle="modal" data-target="#modalAppFm">Approve FM</a>
                              <a href="" class="btn btn-danger mx-2" data-toggle="modal" data-target="#vdr-reject-marine">Reject</a>
                     ...
                     {{-- <div class="table-responsive overflow-auto pb-4" style="height: 700px ">  --}}
                        ...
                        @if ($vdr->status == 2 && auth()->user()->hasRole('marine') )
                           ...
                           <div class="row mb-2">
                              <div class="col-md-12 ">
                                 <div class="d-flex px-2">
                                    <a href="#" class="btn  btn-block  btn-info " data-toggle="modal" data-target="#modalAppMarine">Approve</a>
                                    <a href="" class="btn btn-danger ml-2" data-toggle="modal" data-target="#vdr-reject-marine">Reject</a>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="row mb-2">
                           ...
                           <a href="#" class="btn    btn-info " data-toggle="modal" data-target="#modalAppSuptentLoc">Approve</a>
                           <a href="" class="btn btn-danger ml-2" data-toggle="modal" data-target="#vdr-reject-suptent-loc">Reject</a>
                        </div>
                     </div>
                  </div>
...
@if (auth()->user()->hasRole('marine|suptent_loc|fm|lead') || auth()->user()->hasRole('pet') || auth()->user()->hasRole('suptent')|| auth()->user()->hasRole('chief'))
