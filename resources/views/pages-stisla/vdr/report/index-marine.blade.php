            ...
            <div class="col-md-4">
               <div class="card">
                  <div class="card-body">
                     ...
                     <hr>
                     <form action="{{route('vdr.export.marine.filter')}}" method="POST">
                        @csrf
                        <div class="row">
                           <div class="col-md-12">
                              <div class="form-group">
                                 <label for="from">Vessel</label>
                                 <select name="vessel" id="vessel" required class="form-control ">
                     ...
                     @if ($data == 0)
                         ...
                         <div class="d-flex justify-content-between">
                           ...
                           <div class="text-right">
                              <a href="{{route('vdr.export.multiple', [enkripRambo($from), enkripRambo($to), enkripRambo($vessel->id)])}}" class="btn btn-light btn-lg border" target="_blank">Export PDF</a>
                           </div>
                         </div>
                         <hr>
