            ...
            <div class="card shadow">
               ...
               <div class="card-body">
                  ...
                  <form action="{{route('vessel.update')}}" method="POST">
                        ...
                        <table class="w-100 border">
                           <tbody>
                              ...
                              <tr>
                               ...
                               <tr>
                                 <td class="border">IPB / Non IPB</td>
                                 <td class="border">
                     ...
                     <button class="btn btn-primary shadow mt-2">Update Detail</button>
                     <hr>
                     <a href="#" data-toggle="modal" data-target="#modalResetPassword">Reset Password</a>
