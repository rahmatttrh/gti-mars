                            ...
                            <div class="card-body">
                              ...
                              <input type="text" required class="form-control" id="username" name="username"  >
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="dpa_name"
                                                    name="dpa_name">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="dpa_telp">DPA No. Telp</label>
                                                <input type="text" class="form-control" id="dpa_telp"
                                                    name="dpa_telp">
                                            </div>
                                            <div class="form-group col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="prev_name"
                                                    name="prev_name">
                                            </div>
                                            <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="call_sign"
                                                    name="call_sign">
                                            </div>
                                            <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="classed_by"
                                                    name="classed_by">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="mmsi"
                                                    name="mmsi">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="deadweight">Deadweight </label>
                                                <input type="text" class="form-control" id="deadweight"
                                                    name="deadweight">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="deckspace">Deckspace</label>
                                                <input type="text" class="form-control" id="deckspace"
                                                    name="deckspace">
                                            </div>
                                            <div class="form-group col-md-4">
