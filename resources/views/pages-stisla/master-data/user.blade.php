      ...
      <div class="card border shadow-sm">
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-8">
                        <a href="{{ route('user.export.pdf') }}" target="_blank" class="btn btn-danger btn-sm">
                            <i class="fas fa-file-pdf mr-1"></i> Export PDF
                        </a>
                        <a href="{{ route('intermilan.user.export.pdf') }}" target="_blank" class="btn btn-danger btn-sm">
                           <i class="fas fa-file-pdf mr-1"></i> Manual Book Intermilan User
                       </a>
                        <a href="{{ route('mb.coman.export.pdf') }}" target="_blank" class="btn btn-danger btn-sm">
                           <i class="fas fa-file-pdf mr-1"></i> Manual Book Coman
                        </a>
                        <a href="{{ route('mb.fm.export.pdf') }}" target="_blank" class="btn btn-danger btn-sm">
                           <i class="fas fa-file-pdf mr-1"></i> Manual Book FM
                       </a>
                        <hr>
