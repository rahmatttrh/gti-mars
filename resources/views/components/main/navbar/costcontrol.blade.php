 ...
 <nav class="navbar navbar-expand-lg main-navbar  text-dark">
    ...
    <div class="nav-collapse">
       ...
       <ul class="navbar-nav ">
          ...
          <li class="nav-item text-dark"><a href="/" class="nav-link text-dark"><b>MARS</b></a></li>
 ...
 <nav class="navbar navbar-dark  navbar-secondary navbar-expand-lg " style="background-color: #252e47" >
    <div class="px-3">
       <ul class="navbar-nav">
          ...
          <li class="nav-item px-3 {{ (request()->is('/')) ? 'active' : '' }} {{ (request()->is('timesheet/filter')) ? 'active' : '' }}">
             <a href="/" class="nav-link {{ (request()->is('/')) ? 'text-dark' : 'text-white' }} {{ (request()->is('timesheet/filter')) ? 'text-dark' : 'text-white' }}">
                @if (request()->is('/'))
                <i class="fas fa-fire"></i>
                @endif

                @if (request()->is('timesheet/filter'))
                <i class="fas fa-fire"></i>
                @endif
