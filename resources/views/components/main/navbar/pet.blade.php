...
<nav class="navbar navbar-expand-lg main-navbar">
    <form class="form-inline mr-auto">
        ...
        <div class="nav-collapse d-none d-sm-block">
            ...
            <ul class="navbar-nav ">
                <li class="nav-item active text-dark"><a href="https://app.mars-phe.com"
                        class="nav-link bgb-1 rounded px-2 py-1" style="background-color: #1f4481">HOME</a></li>
                @if (auth()->user()->username == 'pet')
                    <li class="nav-item text-dark"><a href="#" class="nav-link text-dark">DSP</a></li>
                @else
                    <li class="nav-item text-dark"><a href="{{ route('dsp.marine') }}"
                            class="nav-link text-dark">DSP</a></li>
                @endif

                <li class="nav-item text-dark"><a href="{{ route('vdr.marine') }}" class="nav-link text-dark">VDR</a>
                </li>
                <li class="nav-item text-dark"><a href="{{ route('proact') }}" class="nav-link text-dark">PROACT</a>
                </li>
    ...
    <ul class="navbar-nav navbar-right">
        ...
        @else
            <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
                    class="nav-link notification-toggle nav-link-lg {{ count($notifrequests) > 0 ? 'beep' : '' }} {{ count($notifvdrs) > 0 ? 'beep' : '' }}"><i
                        class="far fa-bell text-primary"></i></a>
                <div class="dropdown-menu shadow dropdown-list dropdown-menu-right">
                    ...
                    <div class="dropdown-list-content dropdown-list-icons">
                        ...
                        @else
                            ...
                            <small class="dropdown-item dropdown-item-unread text-muted">Tidak ada Request dari User
                                Field </small>
                        @endif
                        @if (count($notifvdrs) > 0)
                            @foreach ($notifvdrs as $vdr)
                                <a href="{{ route('vdr.show', [enkripRambo($vdr->id), enkripRambo('index')]) }}"
                           ...
                           <i class="fas fa-exclamation"></i>
                            ...
                            @endforeach
                        @else
                            <small class="dropdown-item dropdown-item-unread text-muted">Tidak ada VDR dari vessel
                            </small>
                  ...
                  <div class="dropdown-item-desc text-muted">
                    ...
                    <div class="dropdown-footer text-center">
                        <a href="{{ route('marine.request.list') }}">View Intermilan <i
    ...
    <nav class="navbar navbar-dark  navbar-secondary navbar-expand-lg " style="background-color: #252e47">
        <div class="px-2">
            <ul class="navbar-nav">
                ...
                <li
                    class="nav-item d-block d-sm-none nav-item-b dropdown {{ request()->is('master/data/*') ? 'active' : '' }}">
                    <a href="#" data-toggle="dropdown"
                        class="nav-link has-dropdown {{ request()->is('master/data/*') ? 'text-dark' : 'text-white' }} ">
                ...
                <li class="nav-item nav-item-b  {{ request()->is('vdr/report/*') ? 'active' : '' }}">
                    <a href="{{ route('vdr.export.marine') }}"
                  ...
                  <a href="{{route('images')}}" class="nav-link {{ (request()->is('images/m/*')) ? 'text-dark' : 'text-white' }}">
                    ...
                    <li class="nav-item nav-item-b pr-3 {{ request()->is('marine/daily/*') ? 'active' : '' }}">
                        <a href="#" data-toggle="tooltip" data-placement="top"
                            ...
                            class="nav-link {{ request()->is('marine/daily/*') ? 'text-dark' : 'text-white' }}">
