         ...
         <div class="table-responsive overflow-auto " style="height: 120px">
            <table class="">
               ...
               <tbody>
                  ...
                  @else
                  <tr>
                     <td colspan="4" class="text-center py-3">Tidak ada Sailing Order</td>
                  </tr>
                  @endif
               </tbody>
            </table>
   ...
   <div class="table-responsive mt-4">
      <table class="" id="table-6">
         ...
         <tbody>
            ...
            @else
            <tr>
               <td colspan="5" class="text-center py-3">Anda belum membuat Request Activity</td>
            </tr>
            @endif
         ...
         <div class="table-responsive">
            <table class="table-sm" id="table-6">
               ...
               <tbody>
                  ...
                  @else
                  <tr>
                     <td colspan="2" class="py-3 text-center">Empty</td>
                  </tr>
                  @endif
