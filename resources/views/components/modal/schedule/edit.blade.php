<div class="modal modal-blur fade" id="schedule-edit" tabindex="-1" role="dialog" aria-hidden="true">
         ...
         <form action="{{route('schedule.update')}}" method="POST">
            ...
            <div class="modal-body">
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="form-floating mb-3">
                        <input type="date" required value="{{$schedule->date}}" class="form-control" id="date" name="date" >
                        <label for="date">Date</label>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-floating mb-3">
                        <input type="datetime-local" value="{{$schedule->etd}}" required class="form-control" id="etd" name="etd" >
