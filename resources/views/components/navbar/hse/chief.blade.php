...
<nav class="navbar navbar-expand-lg main-navbar bg-white text-dark">
   ...
   <div class="nav-collapse">
      ...
      <ul class="navbar-nav ">
         ...
         <li class="nav-item active text-dark"><a href="{{route('hse')}}" class="nav-link bgb-1 rounded px-2 py-1">HSE</a></li>
      </ul>
   </div>
...
<nav class="navbar navbar-dark  navbar-secondary navbar-expand-lg " style="background-color: #00A9FF" >
   <div class="container">
      <ul class="navbar-nav">
         <li class="nav-item pr-3 {{ (request()->is('hse/*')) ? 'active' : '' }}">
            <a href="{{route('dsp.fm')}}" class="nav-link {{ (request()->is('hse/*')) ? 'text-dark' : 'text-white' }}">
               @if (request()->is('hse/*'))
