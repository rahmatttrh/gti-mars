...
<nav class="navbar  navbar-expand-lg main-navbar  text-dark"  >
   <form class="form-inline mr-auto">
      <ul class="navbar-nav mr-3">
       ...
       <div class="nav-collapse d-none d-sm-block">
          ...
          <ul class="navbar-nav ">
             <li class="nav-item active text-dark"><a href="https://app.mars-phe.com" class="nav-link bgb-1 rounded px-2 py-1" >HOME</a></li>
             
             <li class="nav-item text-dark"><a href="{{route('dsp.marine')}}" class="nav-link text-dark">DSP</a></li>
             
             <li class="nav-item text-dark"><a href="{{route('vdr.marine')}}" class="nav-link text-dark" style="background-color: #1f4481">VDR</a></li>
   ...
   <div class="nav-collapse">
      ...
      <ul class="navbar-nav ">
         ...
         <li class="nav-item active text-dark"><a href="{{route('vdr.marine')}}" class="nav-link bgb-1 rounded px-2 py-1" data-toggle="tooltip" data-placement="bottom" title="Vessel Daily Report" style="background-color: #1f4481">VDR</a></li>
