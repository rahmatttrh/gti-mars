...
<nav class="navbar navbar-expand-lg main-navbar bg-white text-dark">
   ...
   <div class="nav-collapse">
      ...
      <ul class="navbar-nav ">
         {{-- <li class="nav-item active text-dark"><a href="{{route('dsp.user', [enkripRambo(auth()->user()->getMonth()), enkripRambo(auth()->user()->getYear())])}}" class="nav-link  bgb-1 rounded px-2 py-1" data-placement="bottom" title="Digital Smart Port">DSP</a></li> --}}
         <li class="nav-item text-dark"><a href="/" class="nav-link text-dark" data-toggle="tooltip" data-placement="bottom" title="Vessel Daily Report"><b>Vessel Daily Report</b></a></li>
