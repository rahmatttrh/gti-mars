<nav class="navbar navbar-expand-lg main-navbar">
 ...
 <nav class="navbar navbar-expand-lg main-navbar bg-white text-dark">
   ...
   <a href="#" class="nav-link sidebar-gone-show" data-toggle="sidebar"><i class="fas fa-bars"></i>
   </a>
   <div class="nav-collapse ">
     <a class="sidebar-gone-show nav-collapse-toggle nav-link" href="#">
       <i class="fas fa-ellipsis-v"></i>
     ...
     <ul class="navbar-nav ">
       <li class="nav-item active text-dark"><a href="{{route('dsp.marine')}}" class="nav-link  bgb-1 rounded px-2 py-1">DSP</a></li>
       <li class="nav-item text-dark"><a href="{{route('vdr.marine')}}" class="nav-link text-dark">DVR</a></li>
