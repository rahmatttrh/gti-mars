...
<nav class="navbar navbar-expand-lg main-navbar bg-white text-dark">
   ...
   <div class="nav-collapse">
      ...
      <ul class="navbar-nav ">
         <li class="nav-item active text-dark"><a href="{{route('dsp.vessel')}}" class="nav-link  bgb-1 rounded px-2 py-1">DSP</a></li>
         <li class="nav-item text-dark"><a href="{{route('vdr.create')}}" class="nav-link text-dark">DVR</a></li>
