...
<nav class="navbar navbar-expand-lg main-navbar bg-white text-dark" style="background-color: #d5dcee">
   ...
   <div class="nav-collapse">
      ...
      <ul class="navbar-nav ">
         <li class="nav-item active text-dark"><a href="https://mars-phe.enc.co.id/mars/index.php" class="nav-link  bgb-1 rounded px-2 py-1" data-toggle="tooltip" data-placement="bottom" title="Digital Smart Port">DSP</a></li>
