             ...
             <div class="row align-items-center">
               <div class="col">
                 <h3 class="card-title mb-1">
                   <a href="project-overview.html" class="text-reset">Deliver UI dashboards</a>
                 </h3>
      ...
      <div class="col-lg-12">
         <div class="card mb-2">
            <div class="card-header border-0 bg-secondary text-white">
               <div class="card-title">BOAT PLANNING <span class="text-uppercase text-azure">{{$monthname}}</span></div>
            </div>
