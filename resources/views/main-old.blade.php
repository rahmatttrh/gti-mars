      ...
      <nav class="navbar navbar-secondary navbar-expand-lg border">
        <div class="container">
          @if (auth()->user()->hasRole('marine'))
            <ul class="navbar-nav">
              <li class="nav-item ">
                <a href="{{route('dsp.marine')}}" class="mr-2 btn btn-primary" data-toggle="tooltip" data-placement="bottom" title="Digital Smart Port">
                  {{-- <i class="far fa-heart"></i> --}}
                  <span>DSP</span>
                </a>
              </li>
              <li class="nav-item ">
                <a href="{{route('vdr.marine')}}" class="mr-2 btn btn-primary" data-toggle="tooltip" data-placement="bottom" title="Vessel Daily Report">
            ...
            <ul class="navbar-nav">
              <li class="nav-item ">
                <a href="{{route('dsp.vessel')}}" class="mr-2 btn btn-primary">
                  {{-- <i class="far fa-heart"></i> --}}
                  <span>Digital Smart Port</span>
                </a>
              </li>
              <li class="nav-item ">
                <a href="{{route('vdr.create')}}" class="mr-2 btn btn-primary">
                  {{-- <i class="fa fa-document"></i> --}}
            ...
            <ul class="navbar-nav">
              <li class="nav-item ">
                <a href="{{route('dsp.user')}}" class="mr-2 btn btn-primary">
                  {{-- <i class="far fa-heart"></i> --}}
                  <span>Digital Smart Port</span>
                </a>
              </li>
