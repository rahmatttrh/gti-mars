    ...
    <div class="page-header d-print-none">
        <div class="row align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">
                    CHART VESSEL DAILY REPORT &nbsp; <span class="text-uppercase text-info"> </span>
                </h2>
            </div>
...
<script>
    ...
    am5.ready(function() {
        ...
        var data = <?php echo  $fuels; ?>

        // Iterasi melalui setiap objek dalam variabel data
        data.forEach(function(obj) {
            // Ambil nilai tanggal dari atribut 'date'
            var dateString = obj.tanggal;

            // Konversi tanggal ke timestamp
            var date = new Date(dateString).getTime();

            // Tambahkan atribut date ke dalam objek JSON
            obj.date = date;
        });
