...
@section('title')
    Quick User Guide - Fuel Management
@endsection
...
<div class="px-2">
    ...
    <div class="header-box d-flex justify-content-between align-items-center">
        ...
        <div class="text-end">
            <div class="report-title">QUICK USER GUIDE <br> FUEL MANAGEMENT</div>
        ...
        <div class="card-body">
            ...
            <div class="text-center mb-2 mt-2">
                ...
                <h5 class="font-weight-bold mb-1">
                    Fuel Management Shared Account
                </h5>
            ...
            <div class="col-6">
                ...
                <div class="d-flex align-items-center mb-2">
                    ...
                    <div>
                        ...
                        <small class="text-muted">
                            Homepage manampilkan daftar VDR yang menunggu persetujuan Fuel Management.
                        </small>
                    </div>
            ...
            <div class="col-6">
                ...
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div>
                        ...
                        <small class="text-muted">
                            Sistem menampilkan pop-up konfirmasi approve dan pemilihan PIC Fuel Management
                        </small>
                    </div>
                ...
                <div class="small">
                    ...
                    <div class="d-flex align-items-start mb-2">
                        ...
                        <div>
                            <div class="font-weight-bold text-dark">
                                Pilih PIC Fuel Management
                            </div>

                            <div class="text-muted">
                                Tentukan nama Fuel Management yang bertanggung jawab untuk proses approval VDR.
                            </div>
                        </div>
