...
{
    public function getDistance($vesselLat, $vesselLong, $portLat, $portLong){
        // dd($vesselLat);
        $vessel = new LatLong($vesselLat,$vesselLong);
        $port = new LatLong($portLat,$portLong);
        $calDistance = new DistanceCalculator($vessel, $port);
